...
export const Contact =()=>{
    ...
    const handleSubmit = async (e) => {
      ...
      try {
        const response = await fetch("https://portfolio-website-three-theta-11.vercel.app", {
          method: "POST",
          headers: {
            ...
            <Col md={6} size={12}>
                  <TrackVisibility>
                   {({ isVisible }) =>
                    ...
                    <form name="contact" method="POST" action="https://portfolio-website-three-theta-11.vercel.app" onSubmit={handleSubmit}>
                        <Row>
